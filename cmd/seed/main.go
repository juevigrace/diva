...
var seedPermissions = []seedPermission{
	...
	{models.PERMISSION_USERS_PROFILE_WRITE, "Users Profile Write", "Create and update user profiles", models.ROLE_MODERATOR},
	{models.PERMISSION_USERS_PREFERENCES_READ, "Users Preferences Read", "View user preferences", models.ROLE_MODERATOR},
	{models.PERMISSION_USERS_PREFERENCES_WRITE, "Users Preferences Write", "Create and update user preferences", models.ROLE_MODERATOR},
