...
import io.github.juevigrace.diva.lib.verification.data.api.client.VerificationApi
import io.github.juevigrace.diva.lib.verification.data.api.client.VerificationApiImpl
...
fun verificationModule(): Module {
    return module {
        singleOf(::VerificationApiImpl) bind VerificationApi::class
