package io.github.juevigrace.diva.lib.session.presentation.ui.screen
...
fun SessionScreen(
    ...
    BackHandler { viewModel.onEvent(SessionEvents.OnBack) }
        ...
        if (state.isLoading) {
            ...
            Box(
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    Text(
                        text = "Manage your active sessions.",
